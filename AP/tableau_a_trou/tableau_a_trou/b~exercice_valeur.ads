...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_exercice_valeur" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#180afd4d#;
   pragma Export (C, u00001, "exercice_valeurB");
   ...
   u00124 : constant Version_32 := 16#e2be6588#;
   pragma Export (C, u00124, "tableau_intB");
   u00125 : constant Version_32 := 16#b81c11cc#;
   pragma Export (C, u00125, "tableau_intS");
   ...
   u00138 : constant Version_32 := 16#ee101ba4#;
   pragma Export (C, u00138, "system__memoryB");
   u00139 : constant Version_32 := 16#74d8f60c#;
