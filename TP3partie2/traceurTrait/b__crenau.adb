pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b__crenau.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__crenau.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_crenau");
...
--  BEGIN Object file/option list
   --   H:\M1102\TP3 partie2\traceurTrait\crenau.o
