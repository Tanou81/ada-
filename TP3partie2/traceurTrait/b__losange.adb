pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b__losange.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__losange.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_losange");
...
--  BEGIN Object file/option list
   --   H:\M1102\TP3 partie2\traceurTrait\losange.o
